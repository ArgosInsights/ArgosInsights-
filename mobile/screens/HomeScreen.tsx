...
function getStyles(colors: ColorPalette) {
  ...
  statLabel: { color: colors.muted, fontSize: 10, marginBottom: 7 },
  statValue: { color: colors.white, fontSize: 15.5, fontWeight: '700', marginBottom: 4 },
  statSub: { color: colors.muted2, fontSize: 9.5 },
